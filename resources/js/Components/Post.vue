                ...
                <div class="flex items-center w-full">
                    ...
                    >
                        <input
                            ...
                            class="w-full mx-1 border-none p-0 text-sm bg-[#effef5] placeholder-[#64676b] ring-0 focus:ring-0"
                            type="text"
            ...
            >
                ...
                >
                    <div class="flex items-center w-full mb-1">
                        <Link class="mr-2" :href="route('post.index')">
                            <img
                                class="rounded-full ml-1 min-w-[36px] max-h-[36px]"
                        ...
                        <div class="flex items-center w-full">
                            ...
                            <button
                                v-if="
                                    $page.props.auth.user.id === comment.user_id
                                "
