            ...
            <div class="w-full bg-white">
                <div class="max-w-[1100px] pt-[56px] mx-auto pb-1">
                    ...
                    >
                            ...
                            <div class="md:mt-4 text-center md:text-left -mt-3">
                                ...
                                >
                                    ...
                                    <img
                                        ...
                                        class="rounded-full -ml-1 z-[9] w-[40px] h-[40px] border-white border-2"
                                    />
                                    <img
                                        src="https://picsum.photos/id/143/300/300"
                                        class="rounded-full -ml-1 z-[8] w-[40px] h-[40px] border-white border-2"
                                    />
                                    <img
                                    ...
                                    <img
                                        ...
                                        class="rounded-full -ml-1 z-[6] w-[40px] h-[40px] border-white border-2"
                                    />
                                    <img
                                        src="https://picsum.photos/id/146/300/300"
                                        class="rounded-full -ml-1 z-[5] w-[40px] h-[40px] border-white border-2"
                                    />
                                    <img
                        ...
                        >
                            <button class="flex items-center px-5 font-bold">
                    ...
                    <div
                        class="flex items-center w-full border-t h-[50px] py-[4px]"
                    >
                        <button class="w-[85px]">
                            <div
            ...
            >
                ...
                <div id="PostsSection" class="w-full md:w-7/12 overflow-auto">
                    <CreatePostBox
                        v-if="$page.props.auth.user.id === user.id"
                        :image="user.image"
                        :placeholder="'What\'s on Your Mind Test!' + user.name"
                    />
